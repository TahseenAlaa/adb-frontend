        ...
        >
          ...
          <template v-slot:top>
            <v-toolbar
                flat
            >
              <v-toolbar-title>Diagnosis Management</v-toolbar-title>
              <v-divider
                  class="mx-4"
                  inset
                  vertical
...
export default {
  name: "DiagnosisManagementView.vue",
  components: {
    LoadingDialogCompo,
    RequiredFieldsCompo,
    ErrorCompo
  ...
  methods: {
    ...
    editItem (item) {
      this.editedIndex = this.diagnosisList.indexOf(item)
    ...
    deleteItemConfirm () {
      this.loading_Dialog = true
      // START Delete Item
      httpPOST('api/v1/diagnosis-types/delete', {
    ...
    save () {
      ...
      if (!this.editedItem.title) {
        ...
        if (this.editedIndex > -1) {
          // START Edit Item
          httpPOST('api/v1/diagnosis-types/update', {
          ...
          // START Add New Item
          httpPOST('api/v1/diagnosis-types/store', {
            title: this.editedItem.title
          })
              .then(({data}) => {
                this.diagnosisList = data.data
